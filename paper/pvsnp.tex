...
128                      & 156.2                       & 0.1317* & $1186.03\times$             \\ \hline
256                      & 2,401.8                     & 0.1392* & $17254.31\times$           \\ \hline
512                      & $>10,000$                   & 0.1378* & $>72568.94\times$         \\ \hline
1024 (Tiled)             & $>100,000$                  & 0.251* & $>398406.37\times$        \\ \hline
\hline
\textbf{Extreme Scale}   & \textit{(Projected Time)}   & \textit{(Measured Time)}  & \textit{(Throughput)}   \\ \hline
512 ($m = 10^{10}$)      & $\approx 10^{150}$ years    & \textbf{1268.53 ms}       & \textbf{7.88 B/sec}     \\ \hline
1024 ($m = 10^{10}$)     & $\approx 10^{300}$ years    & \textbf{1903.29 ms}       & \textbf{5.25 B/sec}     \\ \hline
\end{tabular}
