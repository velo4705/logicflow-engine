 ...
 * -----------------------------------------
 * This is the Red Team version of the Hyperflow tool, specifically designed to break it.

 * Here, we increased the normal depth from 4 to 1024 to increase the mean time or make it longer.

 * We configured n_masks[i] = p_masks[i] to break its logic.

 * We also configured the state to be setzero.

 EXPECTED FAILING RESULT: Make the output time longer, and give inaccurate values instead of the correct values.
 =====================================================
